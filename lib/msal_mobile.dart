...
class MsalMobile {
  static const MethodChannel _channel =
      const MethodChannel('com.remy.msal_auth');
  ...
  static Future<MsalMobile> create(
    ...
    try {
      ...
      throw MsalMobileException.fromErrorCodeWithInner(
          ...
          MsalMobileException(message: ex.toString(), errorCode: ex.runtimeType.toString()));
    }
    ...
    if (!result!.isSuccess) {
      if (result.exception != null) {
        if (result.innerException != null) {
          ...
          throw MsalMobileException.copy(result.exception!, null);
        }
      }
    }
    initialized = true;
